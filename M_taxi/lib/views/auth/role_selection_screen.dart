...
import 'package:m_taksi/views/auth/entrepreneur/entrepreneur_phone_screen.dart'; // Tadbirkor telefon ekrani
                      ...
                      _buildRoleButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => const EntrepreneurPhoneScreen(), // Tadbirkor telefon ekrani
                            ),
                          );
                        },
                      ),
